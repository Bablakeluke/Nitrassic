...
namespace Nitrassic.Library
{
	...
	internal sealed class JSONSerializer
	{
		...
		private Stack<Nitrassic.Library.Array> arrayStack;
		...
		public string Serialize(object value)
		{
			...
			this.arrayStack = new Stack<Nitrassic.Library.Array>();
		...
		private void SerializePropertyValue(object value, StringBuilder result)
		{
			...
			// Serialize an array.
			if (value is Nitrassic.Library.Array)
			{
				SerializeArray((Nitrassic.Library.Array)value, result);
				return;
			}
