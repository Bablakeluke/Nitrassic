...
namespace Nitrassic.Library
{
	...
	internal sealed class PropertyAccessorValue
	{
		...
		/// </summary>
		/// <param name="thisObj"> The value of the "this" keyword inside the getter. </param>
		/// <returns> The property value returned by the getter. </returns>
		public object GetValue(ObjectInstance thisObj)
		{
			if (this.getter == null)
		...
		/// </summary>
		/// <param name="thisObj"> The value of the "this" keyword inside the setter. </param>
		/// <param name="value"> The desired value. </param>
		public void SetValue(ObjectInstance thisObj, object value)
		{
			if (this.setter == null)
				return;
