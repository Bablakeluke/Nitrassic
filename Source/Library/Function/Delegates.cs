...
namespace Nitrassic.Library
{
	...
	public delegate object FunctionDelegate(object thisObj, object[] arguments);
	
	/// <summary>
	/// Called once per element by Array.prototype.every, Array.prototype.some and Array.prototype.filter.
	/// </summary>
	/// <param name="thisObj"> The value of the <c>this</c> keyword.  Will be <c>null</c> if
	...
	public delegate bool ArrayConditionDelegate(ObjectInstance thisObj, object value, int index, ObjectInstance array);
	...
	/// <param name="array"> The array that is being operated on. </param>
	/// <returns> The result of a user-defined condition. </returns>
	public delegate void ArrayActionDelegate(ObjectInstance thisObj, object value, int index, ObjectInstance array);
	...
	/// <param name="array"> The array that is being operated on. </param>
	/// <returns> The result of a user-defined condition. </returns>
	public delegate object ArrayMapDelegate(ObjectInstance thisObj, object value, int index, ObjectInstance array);
	...
	public delegate object ArrayReduceDelegate(ObjectInstance thisObj, object previousValue, object currentValue, int index, ObjectInstance array);
}
